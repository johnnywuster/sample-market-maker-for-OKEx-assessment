...
class BitMEX(object):
    ...
    def __init__(self, base_url: object = None, symbol: object = None, apiKey: object = None, apiSecret: object = None,
                 orderIDPrefix: object = 'mm_bitmex_', shouldWSAuth: object = True, postOnly: object = False, timeout: object = 7) -> object:
        """Init connector."""
